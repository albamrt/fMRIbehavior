...
par(mfrow = c(1, 2))
plot(mean_MSE, Sigma, type = 'l', 
     xlim = c(min(c(mean_MSE, mean_MSE3)), max((c(mean_MSE, mean_MSE3)))),
     xlab = 'MSE', ylab = bquote(sigma))
lines(mean_MSE3, Sigma, col = 'orange')
...
### Mean folded serial bias by roup and session
```{r}
groupedSubjSes <- data %>%
